...
class _TapsWidgetState extends State<TapsWidget> {
  ...
  final Map<int, List<String>> categoryImages = {
    ...
    1: ["https://avatars.mds.yandex.net/i?id=c02de98125446bb8ec81e0086eff43c9685ec26f-4008503-images-thumbs&n=13"],
    2: ["https://avatars.mds.yandex.net/i?id=bc7fa24b065cab976f52db11acf6b932ce13abd2-7086399-images-thumbs&n=13"],
    3: ["https://avatars.mds.yandex.net/i?id=c4120bc436ec3e1deed7e2f10925c6320f9982b6-8498443-images-thumbs&n=13"],
    4: ["https://avatars.mds.yandex.net/i?id=a12f76aca28f79e4747f94397eb60f1f6c983869-15365595-images-thumbs&n=13"],
  };
      ...
      children: [
        ...
        GridView.builder(
          ...
          gridDelegate: SliverGridDelegateWithFixedCrossAxisCount(
            ...
            childAspectRatio: widget.isFav ? 0.72 : 0.85,
          ),
          itemCount: categoryImages[selectedTab]?.length ?? 0,
          itemBuilder: (context, index) {
            return GestureDetector(
              onTap: () => goTo(page: const ItemPage()),
              child: Container(
                decoration: BoxDecoration(
                  color: Colors.white,
                          ...
                          if (widget.isFav)
                            Positioned(
                              ...
                              child: CircleAvatar(
                                ...
                                child: Icon(Icons.favorite, color: Theme.of(context).primaryColor, size: 16.sp),
                              ),
                            ),
                        ],
                      ),
                            ...
                            children: [
                              ...
                              Row(
                                children: [
                                  ...
                                  Text(" 4.5", style: TextStyle(fontSize: 11.sp, fontWeight: FontWeight.bold)),
                                ],
                              ),
                            ],
                          ),
